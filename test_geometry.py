...
class TestFaceTopology(unittest.TestCase):
    ...
    def test_plane(self):
        ...
        np.testing.assert_array_almost_equal(np.array([0.5, 1.5, 2.5]), plane.point_at(0.5, 1.5, 2.5))
        ...
        np.testing.assert_array_almost_equal(test_pt, plane.point_at(projected[0], projected[1], projected[2]))


if __name__ == "__main__":
    logging.basicConfig(filename='test_output/test_geometry.log', filemode='w', level=logging.INFO)
    unittest.main()